...
PREDICTIONS_V4: list[tuple[str, str, str, str, bool, str, str]] = [
    ("GBA-1",  "Gilgit-I",     "Amjad Hussain Azar",             "PPP",         False, "PPP",
        "Strong personal vote. Runner-up Independent, third PML-N. Per the survey table."),
    ...
    ("GBA-14", "Astore-II",    "Shamsul Haq Lone",               "IPP",         False, "IPP",
        "Shamsul Haq Lone retained with party switch PML-N -> IPP. Runner-up PPP, third PML-N."),
    ...
    ("GBA-22", "Ghanche-I",    "Dr. Ashiq Hussain",              "PPP",         False, "PPP",
        "PPP holds Ghanche-I. Runner-up PML-N, third Independent. 'Doctor vs turncoat' narrative continues to favour PPP."),
    ("GBA-23", "Ghanche-II",   "Independent (name TBC)",         "Independent", False, "Independent",
        "Ghanche-II open contest. Per the survey, an Independent leads with PPP runner-up. Candidate name not printed in the source table."),
    ("GBA-24", "Ghanche-III",  "Muhammad Ismail",                "PPP",         False, "PPP",
        "PPP flips Ghanche-III. Runner-up Independent. Election scheduling subject to ECGB revision."),
]
